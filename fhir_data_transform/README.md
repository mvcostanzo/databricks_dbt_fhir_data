...
The 'fhir_data_transform' project was generated by using the dbt template for
...
3. Install dbt
   ...
   Run these instructions from the `fhir_data_transform` directory. We recommend making
...
`[dev yourname] fhir_data_transform_job` to your workspace.
...
When deploying to this target, note that the default job at resources/fhir_data_transform.job.yml
